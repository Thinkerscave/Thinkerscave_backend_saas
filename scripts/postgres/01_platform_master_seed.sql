...
(26, 'SUBSCRIPTION_MANAGEMENT', 'Subscription Management', 'Subscription plans and promo codes',     NULL,                                           'pi pi-credit-card', 'MODULE', NULL, 3, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(27, 'TENANT_MANAGEMENT',       'Tenant Management',       'Tenant health, migrations and audit',    NULL,                                           'pi pi-server',      'MODULE', NULL, 5, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(28, 'PLATFORM_CATALOG',        'Platform Catalog',        'Menus and feature catalogue',            NULL,                                           'pi pi-th-large',    'MODULE', NULL, 6, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(14, 'DASHBOARD',               'Dashboard',               'Role-based workspace home',              '/app',                                         'pi pi-home',        'PAGE',   NULL, 1, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(15, 'CUSTOMERS',               'Customers',               'Commercial customer accounts',           '/app/tenant-management/customers',             'pi pi-users',       'PAGE',   NULL, 1, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(16, 'TM_ORGANIZATIONS',        'Organizations',           'Tenant organizations',                   '/app/tenant-management/organizations',         'pi pi-building',    'PAGE',   NULL, 2, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(17, 'SUBSCRIPTION_PLANS',      'Subscription Plans',      'Platform subscription plans',            '/app/tenant-management/subscription-plans',    'pi pi-credit-card', 'PAGE',   26,   1, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(18, 'PROMOTIONS',              'Promo Codes',             'Platform promo codes',                   '/app/tenant-management/promotions',            'pi pi-tag',         'PAGE',   26,   2, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(19, 'FEATURE_CATALOG',         'Feature Catalog',         'Platform feature catalogue',             '/app/tenant-management/feature-catalog',       'pi pi-box',         'PAGE',   28,   2, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(20, 'TENANT_HEALTH',           'Tenant Health',           'Tenant health monitoring',               '/app/tenant-management/tenant-health',         'pi pi-heart',       'PAGE',   27,   1, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(21, 'MIGRATION_CENTER',        'Migration Center',        'Tenant migration jobs',                  '/app/tenant-management/migration-center',      'pi pi-sync',        'PAGE',   27,   2, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0),
(22, 'AUDIT_CENTER',            'Audit Center',            'Platform audit center',                  '/app/tenant-management/audit-center',          'pi pi-history',     'PAGE',   27,   3, TRUE, TRUE, FALSE, 'system', NOW(), 'system', NOW(), 0)
ON CONFLICT (id) DO NOTHING;

-- Keep labels/routes aligned if rows already existed (canonical hierarchy only)
UPDATE menus SET menu_name = 'Dashboard',               route = '/app',                                         icon = 'pi pi-home',        menu_type = 'PAGE',   parent_menu_id = NULL, display_order = 1, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'DASHBOARD';
UPDATE menus SET menu_name = 'Customers',               route = '/app/tenant-management/customers',             icon = 'pi pi-users',       menu_type = 'PAGE',   parent_menu_id = NULL, display_order = 1, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'CUSTOMERS';
UPDATE menus SET menu_name = 'Organizations',           route = '/app/tenant-management/organizations',         icon = 'pi pi-building',    menu_type = 'PAGE',   parent_menu_id = NULL, display_order = 2, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'TM_ORGANIZATIONS';
UPDATE menus SET menu_name = 'Subscription Management', route = NULL,                                           icon = 'pi pi-credit-card', menu_type = 'MODULE', parent_menu_id = NULL, display_order = 3, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'SUBSCRIPTION_MANAGEMENT';
UPDATE menus SET menu_name = 'Subscription Plans',      route = '/app/tenant-management/subscription-plans',    icon = 'pi pi-credit-card', menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'SUBSCRIPTION_MANAGEMENT'), display_order = 1, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'SUBSCRIPTION_PLANS';
UPDATE menus SET menu_name = 'Promo Codes',             route = '/app/tenant-management/promotions',            icon = 'pi pi-tag',         menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'SUBSCRIPTION_MANAGEMENT'), display_order = 2, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'PROMOTIONS';
UPDATE menus SET menu_name = 'Tenant Management',       route = NULL,                                           icon = 'pi pi-server',      menu_type = 'MODULE', parent_menu_id = NULL, display_order = 5, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'TENANT_MANAGEMENT';
UPDATE menus SET menu_name = 'Tenant Health',           route = '/app/tenant-management/tenant-health',         icon = 'pi pi-heart',       menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'TENANT_MANAGEMENT'), display_order = 1, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'TENANT_HEALTH';
UPDATE menus SET menu_name = 'Migration Center',        route = '/app/tenant-management/migration-center',      icon = 'pi pi-sync',        menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'TENANT_MANAGEMENT'), display_order = 2, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'MIGRATION_CENTER';
UPDATE menus SET menu_name = 'Audit Center',            route = '/app/tenant-management/audit-center',          icon = 'pi pi-history',     menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'TENANT_MANAGEMENT'), display_order = 3, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'AUDIT_CENTER';
UPDATE menus SET menu_name = 'Platform Catalog',        route = NULL,                                           icon = 'pi pi-th-large',    menu_type = 'MODULE', parent_menu_id = NULL, display_order = 6, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'PLATFORM_CATALOG';
UPDATE menus SET menu_name = 'Feature Catalog',         route = '/app/tenant-management/feature-catalog',       icon = 'pi pi-box',         menu_type = 'PAGE',   parent_menu_id = (SELECT id FROM menus WHERE menu_code = 'PLATFORM_CATALOG'), display_order = 2, show_in_sidebar = TRUE, active = TRUE WHERE menu_code = 'FEATURE_CATALOG';

-- Deactivate legacy duplicate roots if they still exist from older seeds
...
SELECT 1, 6, m.id, TRUE, TRUE,
       CASE WHEN m.menu_code IN ('CUSTOMERS', 'TM_ORGANIZATIONS', 'FEATURE_CATALOG') THEN TRUE ELSE FALSE END,
       'system', NOW(), 'system', NOW(), 0
FROM menus m

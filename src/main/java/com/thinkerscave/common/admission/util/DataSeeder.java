...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                createInquiry("Rohan Sharma", "9876543210", "rohan@example.com", "Class 10", "WEBSITE",
                ...
                createInquiry("Vikash Singh", "9988776655", "vikash@example.com", "Class 10", "PHONE",
                                InquiryStatus.NEW,
                                LocalDate.now().plusDays(5), null, false); // New
                createInquiry("Meera Nair", "8877665544", "meera@example.com", "Class 9", "AD", InquiryStatus.LOST,
                                null,
                                "Email", true); // Lost
                ...
                createInquiry("Jane Smith", "3213214321", "jane@test.com", "Class 7", "WALK_IN",
                                InquiryStatus.CONTACTED,
                ...
                createInquiry("Michael Brown", "1112223333", "mike@test.com", "Class 12", "REFERRAL",
                                InquiryStatus.CONTACTED,
                                LocalDate.now(), "WhatsApp", true); // Today
                createInquiry("Sarah Miller", "4445556666", "sarah@test.com", "Class 10", "SOCIAL_MEDIA",
                                InquiryStatus.NEW,
                ...
                createInquiry("Jennifer Martinez", "2223334444", "jen@test.com", "Class 11", "WALK_IN",
                                InquiryStatus.CONTACTED,

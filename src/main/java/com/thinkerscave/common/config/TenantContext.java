 ...
 *
 * It uses ThreadLocal to ensure that tenant information is scoped per request/thread,
 * which is crucial in multi-tenant applications where different users may belong to
 * different tenants concurrently.
 */
public class TenantContext {

    // Thread-local variable to hold the tenant identifier for the current thread/request

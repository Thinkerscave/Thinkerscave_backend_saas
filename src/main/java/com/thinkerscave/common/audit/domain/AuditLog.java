...
/**
 * Unified audit log — every meaningful business action writes one row.
 *
 * <p>Designed for both Postgres and H2 (no {@code jsonb}; uses
 * {@code CLOB / TEXT} for the {@code changes} payload — store JSON as a
 * string).
 */
@Entity

...
-- privilege_master definition

-- Drop table

-- DROP TABLE privilege_master;
...
INSERT INTO role_master (role_name, role_code, description, is_active, role_type)
VALUES ('Admin', 'Admin', 'Administrator role with full privileges', true, 'ADMIN')
    ON CONFLICT (role_code) DO NOTHING;

INSERT INTO role_master (role_name, role_code, description, is_active, role_type)
VALUES ('User', 'User', 'Standard user role', true, 'SCHOOL')
    ON CONFLICT (role_code) DO NOTHING;


-- schema_meta_data definition

-- Drop table

-- DROP TABLE schema_meta_data;

CREATE TABLE IF NOT EXISTS schema_meta_data (
...
CREATE TABLE IF NOT EXISTS guardian (
    ...
    CONSTRAINT fk78238bh00pipro62xntxayb9x FOREIGN KEY (user_id) REFERENCES users(id)
    );
...
CREATE TABLE IF NOT EXISTS organisation (
    ...
    CONSTRAINT fk7fe1cxfbwcb8f0ns4xvaniyao FOREIGN KEY (parent_org_id) REFERENCES organisation(org_id),
    CONSTRAINT fkdiyk5ra1jiihwhyoev7u9etp9 FOREIGN KEY (user_id) REFERENCES users(id)
    );


-- owner_details definition
...
CREATE TABLE IF NOT EXISTS owner_details (
    ...
    CONSTRAINT fk5638gjc6jkwq0gj6adp1bak4i FOREIGN KEY (org_id) REFERENCES organisation(org_id),
    CONSTRAINT fkiuk30qky3ejwp35qeq3hbr4d8 FOREIGN KEY (user_id) REFERENCES users(id)
    );


-- password_reset_token definition
...
CREATE TABLE IF NOT EXISTS "section" (
    ...
    CONSTRAINT fkmp0d1954x86u7s6939a7iqk5d FOREIGN KEY (class_entity_class_id) REFERENCES "class"(class_id)
    );
...
CREATE TABLE IF NOT EXISTS staff (
    ...
    CONSTRAINT fk686rqn8cpu4ncey4odd8cw3hm FOREIGN KEY (department_id) REFERENCES department(department_id),
...
CREATE TABLE IF NOT EXISTS student (
    ...
    CONSTRAINT fkhbvsrbyf0pkgo53royos2qk4k FOREIGN KEY (current_address_id) REFERENCES address(id),
    CONSTRAINT fkj1c0de75pterue04btw6w5mh8 FOREIGN KEY (section_id) REFERENCES "section"(section_id),
    CONSTRAINT fkk0thg920a3xk3v59yjbsatw1l FOREIGN KEY (user_id) REFERENCES users(id),
    CONSTRAINT fkkktpamdaydbva4kxjcn17sbvk FOREIGN KEY (guardian_id) REFERENCES guardian(guardian_id)
    );


-- sub_menu_master definition

-- Drop table

-- DROP TABLE sub_menu_master;
...
CREATE TABLE IF NOT EXISTS sub_menu_master (
    ...
    CONSTRAINT fkb85x2ldxes2aawp2tm6l22agr FOREIGN KEY (menu_id) REFERENCES menu_master(menu_id)
    );


-- submenu_privilege_mapping definition

-- Drop table

-- DROP TABLE submenu_privilege_mapping;

CREATE TABLE IF NOT EXISTS submenu_privilege_mapping (
    ...
    CONSTRAINT fk7svjf9w09egt2fhat8cr7w4ix FOREIGN KEY (privilege_id) REFERENCES privilege_master(privilege_id),
    CONSTRAINT fkgw4uli0ql5yynwwdqtoercoel FOREIGN KEY (sub_menu_id) REFERENCES sub_menu_master(sub_menu_id)
    );
...
-- role_submenu_privilege_mapping definition

-- Drop table

-- DROP TABLE role_submenu_privilege_mapping;

CREATE TABLE IF NOT EXISTS role_submenu_privilege_mapping (
                                                              mapping_id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    created_by varchar(255) NULL,
    created_date timestamp(6) NULL,
    last_modified_by varchar(255) NULL,
    ...
    CONSTRAINT fk7jqt3j378sy52a8geufpb8hpw FOREIGN KEY (role_id) REFERENCES role_master(role_id),
    CONSTRAINT fkb6vl70k1ulwfka5h5fejkv5u5 FOREIGN KEY (sub_menu_id) REFERENCES sub_menu_master(sub_menu_id),
    CONSTRAINT fkhj9xptnt4ge1mhhj5codj6cui FOREIGN KEY (privilege_id) REFERENCES privilege_master(privilege_id)
    );
